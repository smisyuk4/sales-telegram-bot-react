...
var require_notiflix_confirm_aio = __commonJS({
  "node_modules/notiflix/build/notiflix-confirm-aio.js"(exports, module) {
    (function(root, factory) {
      ...
      var confirmCreate = function(confirmType, title, messageOrQuestion, answer, okButtonText, cancelButtonText, okButtonCallback, cancelButtonCallback, options) {
        ...
        if (typeof okButtonCallback !== "function") {
          okButtonCallback = void 0;
        }
        if (typeof cancelButtonCallback !== "function") {
          cancelButtonCallback = void 0;
        }
        ...
        var ntflxConfirmWrap = window2.document.createElement("div");
        ...
        if (!window2.document.getElementById(ntflxConfirmWrap.id)) {
          window2.document.body.appendChild(ntflxConfirmWrap);
          var confirmCloseWrap = window2.document.getElementById(ntflxConfirmWrap.id);
          var okButton = window2.document.getElementById("NXConfirmButtonOk");
          var validationInput = window2.document.getElementById("NXConfirmValidationInput");
          if (validationInput) {
          ...
          if (typeof okButtonCallback === "function") {
            var cancelButton = window2.document.getElementById("NXConfirmButtonCancel");
      ...
      if (typeof window2.Notiflix === "object") {
        return commonExtendOptions(true, window2.Notiflix, { Confirm: Notiflix.Confirm });
      } else {
...
export default require_notiflix_confirm_aio();
//# sourceMappingURL=notiflix_build_notiflix-confirm-aio.js.map
