import { DivStyled } from './Ruls.styled';
  ...
  return (
    <DivStyled>
      ...
      <ol>
        ...
        <li>
          Один оголошення на один товар: Заборонено дублювати оголошення для
      ...
      <ul>
        ...
        <ul>
          Наприклад:
          <li>Куплю/Продам Iphone 12, 64 ГБ.</li>
          <li>
            Опис товару: Вказати основні характеристики, стан, комплектацію.
          </li>
          <li>
            Ціна: Укажіть ціну товару. Якщо є можливість торгу, зазначте це.
          </li>
          Контактна інформація: Номер телефону або телеграм для зв'язку з вами.
        </ul>

        <li>Фотографії: Додайте до 5 фото товару з різних кутів.</li>
      </ul>
    </DivStyled>
  );
};
